...
PHP_MINIT_FUNCTION(eio)
{
	...
	php_eio_eventfd = eventfd(0, EFD_NONBLOCK);
...
PHP_FUNCTION(eio_open)
{
    ...
    long flags;
    long mode; 
    PHP_EIO_INIT(pri, callback, data, eio_cb, req);
 ...
 * c-basic-offset: 4
 * End:
 * vim600: noet ci pi sts=4 sw=4 ts=8 fdm=marker
